...
public class ConnectingDots {
    ...
    // Now Gary is getting bored and wants to play a game. The key of this game is
    // to find a cycle that contain dots of same colour. Formally, we call a
    // sequence of dots d1, d2, ..., dk a cycle if and only if it meets the
    // following condition:
    ...
    // N is number of rows and M is the number of columns of the board.
